...
const setYLabelAxis = (data, yGroupBy, 
  yGroupByType, x1Key, x2Key, transition = false) => {
...
const sicklistDataTypes = {
  ...
  Height_Total_Inches: 'Numerical',
  Height_Total_InchesJ: 'Numerical'
};
...
const initSicklist = (shipyearsData, sicklistData) => {
  ...
  * ------------------------------------------------------------------------------------------ */
  ...
  const xAxisJitter = false;

  let currentSortBy = 'OnInDays';
  let currentGroupBy = '';
  let currentSortByJitter = false;
  ...
  * SORTING
  * ------------------------------------------------------------------------------------------ */
  $('#sortSelect') // TODO: get rid of jquery
    .change(() => {
      setYSortBy($('#sortSelect').val());
      applyTransitions('sortBySelected');
    });

  $('#sortJitter') // TODO: get rid of jquery
    .click((evt) => {
      currentSortByJitter = $('#sortJitter')
        .is(':checked');
  ...
  * COLOUR SELECTION
  * ------------------------------------------------------------------------------------------ */
  $('#colourSelect') // TODO: get rid of jquery
    .change(() => {
  ...
  $('#colourSchemeSelect') // TODO: get rid of jquery
    .change(() => {
  ...
  $('#colourSchemeInvert') // TODO: get rid of jquery
    .click((evt) => {
  ...
  $('#opacitySlider') // TODO: get rid of jquery
    .change(() => {
  ...
  $('#animateInvert') // TODO: get rid of jquery
    .click((evt) => {
  ...
  * ------------------------------------------------------------------------------------------ */
  ...
  $('input[name=\'xAxis\']') // TODO: get rid of jquery
    .change((evt) => {
  ...
  * ------------------------------------------------------------------------------------------ */
  ...
  $('#filterShowBtn') // TODO: get rid of jquery
    .click(() => {
      showFilterOverlay();
    });
